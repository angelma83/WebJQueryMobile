...
mysqli_select_db($conexion, 'pruebas') or die("no fue posible conectar con BBDD");
...
$acierto = "SELECT * FROM usuarios WHERE usuario = '$user'";
$ejecutoAcierto = mysqli_query($conexion, $acierto);


if(mysqli_num_rows($ejecutoAcierto)==0){

	$nuevoUser= "INSERT INTO usuarios (usuario,password) values ('$user', '$pass')";
...
if ($filaBBDD[1] ==$user && $filaBBDD[2] == $pass){
